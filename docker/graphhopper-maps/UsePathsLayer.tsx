...
function addUnselectedPathsLayer(map: Map, paths: Path[]) {
    const styleArray = [
        new Style({
            stroke: new Stroke({
                // monokai dark theme: dim grey-violet halo for alternative routes
                color: 'rgba(30,25,35,0.85)',
                width: 6,
            }),
        }),
        new Style({
            stroke: new Stroke({
                color: 'rgba(117,113,94,0.75)',
                width: 4,
            }),
        }),
    ]
...
const selectedPathStyle = [
    new Style({
        stroke: new Stroke({
            // monokai dark theme: dark halo instead of white, fuchsia core instead of navy blue
